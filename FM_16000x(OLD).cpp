...
const static short	NUM_GLOBAL_PARAM = 39;
const static short	NUM_LOCAL_PARAM = 70;
...
int FAS_MoveArcAbsPosWithSealOff(int iBdID, WORD NoOfAxis, WORD *Axis, double *AbsPos, 
			...
			double dDispensingOffDistancePos, DWORD dwOffValue, BOOL bIsLow)
{
	int i;
	int TempAxis = 0;
	int iTmpAxis = 0;
	...
	FAS_WriteRam(iBdID, AXIS_GLOBAL, ukPressureControlOn,  (long)FALSE/*bPressureControlOn*/);	// Corner Gap, 감압 유무 Flag를 강제로 FALSE
	...
	FAS_WriteRam(iBdID, AXIS_GLOBAL, ukMusashiOffPos, (long)dDispensingOffDistancePos); 
...
int FAS_MoveArcAbsPosWithSealOff(int iBdID, WORD NoOfAxis, WORD *Axis, double *AbsPos, 
			double D_Feedrate, double D_CirFeedrate, double CornerDistance, WORD D_StartEndPoint, 
			double dUpDistancePos, WORD wOffNoOfAxis, int *piOffAxis, double *pdOffIncPos, double *pdOffVelocity,
			double dDispensingOffDistancePos, DWORD dwOffValue, BOOL bIsLow,  double dUpDistancePos2, double *pdOffIncPos2)
{
	int i;
	int TempAxis = 0;
	int iTmpAxis = 0;	
...
int FAS_MoveArcAbsPosWithSealOff(int iBdID, WORD NoOfAxis, WORD *Axis, double *AbsPos, 
			double D_Feedrate, double D_CirFeedrate, double CornerDistance, WORD D_StartEndPoint, 
			double dUpDistancePos, WORD wOffNoOfAxis, int *piOffAxis, double *pdOffIncPos, double *pdOffVelocity,
			double dDispensingOffDistancePos, DWORD dwOffValue, BOOL bIsLow,  double dUpDistancePos2, double *pdOffIncPos2, BOOL bPressureControlOn)
{
	int i;
	int TempAxis = 0;
	int iTmpAxis = 0;	
...
/* ------------------------------------------------------------------------------------------------ */
int FAS_MoveArcAbsPosWithSealOffStartStop(int iBdID, WORD NoOfAxis, WORD *Axis, double *AbsPos, 
			double D_Feedrate, double D_CirFeedrate, double CornerDistance, WORD D_StartEndPoint, 
			double dUpDistancePos, WORD wOffNoOfAxis, int *piOffAxis, double *pdOffIncPos, double *pdOffVelocity,
			double dDispensingOffDistancePos, DWORD dwOffValue, BOOL bIsLow, 
			double dUpDistancePos2, double *pdOffIncPos2, BOOL bPressureControlOn,
			WORD wStartStopSequence, double dStartAccTime, double dStartOverlapSpeed) 
{
    int i;
	int TempAxis = 0;
	int iTmpAxis = 0;
	...
	//============================================================================
	FAS_WriteRam(iBdID, AXIS_GLOBAL, ukStartAccTime,      (long)dStartAccTime);
    FAS_WriteRam(iBdID, AXIS_GLOBAL, ukStartStopSequence, (long)wStartStopSequence);
    FAS_WriteRam(iBdID, AXIS_GLOBAL, ukStartOverlapSpeed, (long)dStartOverlapSpeed);
    //============================================================================
	//----------------------------------------------------------------------------
	FAS_WriteRam(iBdID, AXIS_GLOBAL, ukDropStartPos,   (long)dUpDistancePos);
    FAS_WriteRam(iBdID, AXIS_GLOBAL, ukDropStartPos2,  (long)dUpDistancePos2);	// 2nd Z Up Start Dist를 1st Z Up Start Dist와 동일하게 설정
	FAS_WriteRam(iBdID, AXIS_GLOBAL, ukPressureControlOn,  (long)bPressureControlOn);	// Corner Gap, 감압 유무 Flag를 강제로 FALSE
...
int FAS_MoveArcAbsPosWithSealOffStartStop(int iBdID, WORD NoOfAxis, WORD *Axis, double *AbsPos, 
			...
			double dUpDistancePos2, double *pdOffIncPos2, BOOL bPressureControlOn,
			WORD   wStartStopSequence, double dStartAccTime, double dStartOverlapSpeed,
			double dStartGapChangePos, double *pdStartGapChangeValue, double dStartDispensingOnPos) 
{
    int i;
	int TempAxis = 0;
	int iTmpAxis = 0;
	...
	FAS_WriteRam(iBdID, AXIS_GLOBAL, ukStartGapChangePos,    (long)dStartGapChangePos);
    FAS_WriteRam(iBdID, AXIS_GLOBAL, ukStartDispensingOnPos, (long)dStartDispensingOnPos);
	...
	for (i=0; i<wOffNoOfAxis; i++)
	{
		...
		// ================================================================================
        FAS_WriteRam(iBdID, piOffAxis[i], ukStartGapChangeValue,  (long)pdStartGapChangeValue[i]);
   // ================================================================================
