...
// Disp Off + Z Up + Corner Gap, Pressure Control Disable
...
// Disp Off + 1st Z Up + 2nd Z Up + Corner Gap, Pressure Control Disable
int FAS_MoveArcAbsPosWithSealOff(int iBdID, WORD NoOfAxis, WORD *Axis, double *AbsPos, 
			double D_Feedrate, double D_CirFeedrate, double CornerDistance, WORD D_StartEndPoint, 
			double dUpDistancePos, WORD wOffNoOfAxis, int *piOffAxis, double *pdOffIncPos, double *pdOffVelocity,
			double dDispensingOffDistancePos, DWORD dwOffValue, BOOL bIsLow,  double dUpDistancePos2, double *pdOffIncPos2);

// Disp Off + 1st Z Up + 2nd Z Up + Corner Gap, Pressure Control Flag
int FAS_MoveArcAbsPosWithSealOff(int iBdID, WORD NoOfAxis, WORD *Axis, double *AbsPos, 
			double D_Feedrate, double D_CirFeedrate, double CornerDistance, WORD D_StartEndPoint, 
			double dUpDistancePos, WORD wOffNoOfAxis, int *piOffAxis, double *pdOffIncPos, double *pdOffVelocity,		
...
// Add 2005/03/28
//int FAS_GetLaserSenser(int iBdID, WORD wChannel, long *lGetLaser);
