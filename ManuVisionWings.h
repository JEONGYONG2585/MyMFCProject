...
#pragma once
#endif // _MSC_VER > 1000
// ManuVisionWings.h : header file
//

/////////////////////////////////////////////////////////////////////////////
// CManuVision dialog

class CManuVisionWings : public CDialog
{
// Construction
public:
	void SelectLanguage();
	...
	void Disp_Progress();
	void OnDisp_Param();
	CManuVisionWings(CWnd* pParent = NULL);   // standard constructor

// Dialog Data
	//{{AFX_DATA(CManuVision)
	enum { IDD = IDD_MANU_VISION_WINGS };
	int		m_nMode;
	...
	CLabelControl	m_ctrlSetCaption;
	//}}AFX_DATA
