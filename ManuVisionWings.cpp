// ManuVisionWings.cpp : implementation file
//
...
CManuVisionWings::CManuVisionWings(CWnd* pParent /*=NULL*/)
	: CDialog(CManuVisionWings::IDD, pParent)
{
...
void CManuVisionWings::DoDataExchange(CDataExchange* pDX)
{
	CDialog::DoDataExchange(pDX);
	//{{AFX_DATA_MAP(CManuVisionWings)
...
BEGIN_MESSAGE_MAP(CManuVisionWings, CDialog)
...
BOOL CManuVisionWings::OnInitDialog() 
{
	CString str;
...
void CManuVisionWings::OnDisp_Param()
{
	CMainFrame *pFrame = (CMainFrame*)AfxGetMainWnd();
	CP8CA_LcDispDoc *pDoc = (CP8CA_LcDispDoc*)pFrame->GetActiveDocument();
...
//220603 BIG DROP DETECT ( (OLD) DEEP DROP ) 	
	str.Format("%d", _NVision.m_structRecipe_Info_Lc.m_nDropSizeRate_X);
	SetDlgItemText(IDC_SIZEX_BIGDROP, str);
	str.Format("%d", _NVision.m_structRecipe_Info_Lc.m_nDropSizeRate_Y);
	SetDlgItemText(IDC_SIZEY_BIGDROP, str);
	str.Format("%d", _NVision.m_structRecipe_Info_Lc.m_nDetectBigDrop_Rate[0]);
	SetDlgItemText(IDC_DETECT_BIGDROP, str);
	str.Format("%d", _NVision.m_structRecipe_Info_Lc.m_nDetectBigDrop_Rate[1]);
	SetDlgItemText(IDC_DETECT_BIGDROP2, str);
	str.Format("%d", _NVision.m_structRecipe_Info_Lc.m_nDetectBigDrop_Rate[2]);
	SetDlgItemText(IDC_DETECT_BIGDROP3, str);
//220603 BIG DROP DETECT ( (OLD) DEEP DROP ) 
	...
	str.Format("%.3f", _NVision.m_structRecipe_Info_Lc.m_dDrop_Size_X[0]);
	SetDlgItemText(IDC_SIZEX, str);
	str.Format("%.3f", _NVision.m_structRecipe_Info_Lc.m_dDrop_Size_Y[0]);
	...
	str.Format("%.2f", _NVision.m_structRecipe_Info_Lc.m_dDrop_Close[0]);
	SetDlgItemText(IDC_CLOSING, str);
	...
	_NVision.m_structScan_Info.m_bDir_TTB ? str = "TOP to BOTTOM" : str = "BOTTOM to TOP";
	SetDlgItemText(IDC_DIRECTION, str);

	for(int i = 0; i < MAX_NOZZLE; i++)
	{
		str.Format("%.2f", pDoc->m_dVision_X_Offset[i]);
		SetDlgItemText(IDC_OFFSET_X1+i, str);
		str.Format("%.2f", pDoc->m_dVision_Y_Offset[i]);
...
BEGIN_EVENTSINK_MAP(CManuVisionWings, CDialog)
    //{{AFX_EVENTSINK_MAP(CManuVisionWings)
	ON_EVENT(CManuVisionWings, IDC_INITIAL, -600 /* Click */, OnClickInitial, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_WRITE_PATH, -600 /* Click */, OnClickWritePath, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_WRITE_RECIPE, -600 /* Click */, OnClickWriteRecipe, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_WRITE_CELL, -600 /* Click */, OnClickWriteCell, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_MOVING, -600 /* Click */, OnClickMoving, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_RETURN, -600 /* Click */, OnClickReturn, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET1, -600 /* Click */, OnClickOffset1, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET2, -600 /* Click */, OnClickOffset2, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET3, -600 /* Click */, OnClickOffset3, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET4, -600 /* Click */, OnClickOffset4, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET5, -600 /* Click */, OnClickOffset5, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET6, -600 /* Click */, OnClickOffset6, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET7, -600 /* Click */, OnClickOffset7, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET8, -600 /* Click */, OnClickOffset8, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET9, -600 /* Click */, OnClickOffset9, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET10, -600 /* Click */, OnClickOffset10, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET11, -600 /* Click */, OnClickOffset11, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET12, -600 /* Click */, OnClickOffset12, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_SAVE_OFFSET, -600 /* Click */, OnClickSaveOffset, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_TITLE, -601 /* DblClick */, OnDblClickTitle, VTS_DISPATCH)
	ON_EVENT(CManuVisionWings, IDC_CAL_START, -600 /* Click */, OnClickCalStart, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_HEAD_NO, -600 /* Click */, OnClickHeadNo, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_S_START, -600 /* Click */, OnClickSStart, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_K_START_POS, -600 /* Click */, OnClickKStartPos, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_K_END_POS, -600 /* Click */, OnClickKEndPos, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_S_MOVE_COUNT, -600 /* Click */, OnClickSMoveCount, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_S_MOVE_DIST, -600 /* Click */, OnClickSMoveDist, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_DROP_AMOUNT, -600 /* Click */, OnClickDropAmount, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET13, -600 /* Click */, OnClickOffset13, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET14, -600 /* Click */, OnClickOffset14, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET15, -600 /* Click */, OnClickOffset15, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET16, -600 /* Click */, OnClickOffset16, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X1, -600 /* Click */, OnClickOffsetX1, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X2, -600 /* Click */, OnClickOffsetX2, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X3, -600 /* Click */, OnClickOffsetX3, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X4, -600 /* Click */, OnClickOffsetX4, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X5, -600 /* Click */, OnClickOffsetX5, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X6, -600 /* Click */, OnClickOffsetX6, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X7, -600 /* Click */, OnClickOffsetX7, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X8, -600 /* Click */, OnClickOffsetX8, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X9, -600 /* Click */, OnClickOffsetX9, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X10, -600 /* Click */, OnClickOffsetX10, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X11, -600 /* Click */, OnClickOffsetX11, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X12, -600 /* Click */, OnClickOffsetX12, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X13, -600 /* Click */, OnClickOffsetX13, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X14, -600 /* Click */, OnClickOffsetX14, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X15, -600 /* Click */, OnClickOffsetX15, VTS_NONE)
	ON_EVENT(CManuVisionWings, IDC_OFFSET_X16, -600 /* Click */, OnClickOffsetX16, VTS_NONE)
	//}}AFX_EVENTSINK_MAP
END_EVENTSINK_MAP()

void CManuVisionWings::OnClickInitial() 
{
	OnBtn_Ctr(FALSE);
	Sleep(200);
...
void CManuVisionWings::OnClickWritePath() 
{
	CMainFrame* pFrame = (CMainFrame*)AfxGetMainWnd();
...
void CManuVisionWings::Disp_Progress()
{
...
void CManuVisionWings::OnBtn_Ctr(BOOL bOn)
{
	CMainFrame *pFrame = (CMainFrame*)AfxGetMainWnd();
...
void CManuVisionWings::OnClickWriteRecipe() 
{
	CMainFrame* pFrame = (CMainFrame*)AfxGetMainWnd();
	CP8CA_LcDispView* pView = (CP8CA_LcDispView*)pFrame->GetActiveView();
	CP8CA_LcDispDoc* pDoc = (CP8CA_LcDispDoc*)pFrame->GetActiveDocument(); //160903 DUAL INTENSITY //160929 JYKIM 
...
//160903 DUAL INTENSITY //160929 JYKIM
	...
	{
		CString str = "THRESHOLD_INFO";
		
		_NVision.Write_CSV_File(_CSV_THRESHOLD_INFO);
		if(_NVision.SendMsg_to_Vision(_SEND_REQ_FILE_READ, str, &nRet).Compare(str) != 0)
		{
			//AfxMessageBox("Vision Send to Dispenser 'NG'");
			pView->SendMessage(WM_ERROR, 406, NULL);
...
void CManuVisionWings::OnClickWriteCell() 
{
	CMainFrame* pFrame = (CMainFrame*)AfxGetMainWnd();
	CP8CA_LcDispView* pView = (CP8CA_LcDispView*)pFrame->GetActiveView();
	CP8CA_LcDispDoc* pDoc = (CP8CA_LcDispDoc*)pFrame->GetActiveDocument(); //JYKIM 161219 PART SCAN 180K
...
//////////////////////////////////////////////////////////////////////////////////
	else	//JYKIM 161219 PART SCAN 180K
	{
		CString str = "CELL_INFO_N_GENTRY";
		_NVision.Write_CSV_File(_CSV_CELL_INFO_N_GANTRY);
		if(_NVision.SendMsg_to_Vision(_SEND_REQ_FILE_READ, str, &nRet).Compare(str) != 0)
		{
			//AfxMessageBox("Vision Send to Dispenser 'NG'");
			pView->SendMessage(WM_ERROR, 406, NULL);
...
void CManuVisionWings::OnClickMoving() 
{
	CMainFrame *pFrame = (CMainFrame*)AfxGetMainWnd();
	CP8CA_LcDispDoc *pDoc = (CP8CA_LcDispDoc*)pFrame->GetActiveDocument();
	CP8CA_LcDispView *pView = (CP8CA_LcDispView*)pFrame->GetActiveView();
	...
	if(_NVision.m_structRecipe_Info_Lc.m_nK_Vel > 500)
	{
...
//		Send_Msg_2_Vision(_SEND_NOT_STOP);
		...
		if(_NVision.m_structVision_Status.m_bComm_Ok)
		{
			pView->Send_Msg_2_Vision(_SEND_NOT_FILE_PATH);
 			...
 			if(!pDoc->m_structN_Vision.m_bPartScanMode) //jykim 161219 PART SCAN 180K
 			_NVision.m_structVision_Status.m_nError_Code = pView->Write_2_Vision(_CSV_CELL_INFO);
			else
			_NVision.m_structVision_Status.m_nError_Code = pView->Write_2_Vision(_CSV_CELL_INFO_N_GANTRY);//JYKIM 161219 PART SCAN
...
//		FAS_MoveSingleAxisAbsPos(AXIS_Y/BOARD_AXES+1, AXIS_Y%BOARD_AXES, pDoc->m_dTeachData[28][0]*1000, pDoc->m_dTeachData[31][2]*1000, 1);
		...
		//Write Scan Info...
		if(pDoc->m_structN_Vision.m_bPartScanMode)
		_NVision.m_structScan_Info.m_nPartScanmode = 0;//JYKIM 161219 PART SCAN 매뉴얼 모드에서는 무조건 0 180K 
...
void CManuVisionWings::OnTimer(UINT nIDEvent) 
{
	switch (nIDEvent)
	{
...
void CManuVisionWings::OnClickReturn() 
{
	KillTimer(0);
	CDialog::OnOK();	
}

void CManuVisionWings::OnClickOffset1() 
{
	Use_TK(m_ctrlH1,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset2() 
{
	Use_TK(m_ctrlH2,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset3() 
{
	Use_TK(m_ctrlH3,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset4() 
{
	Use_TK(m_ctrlH4,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset5() 
{
	Use_TK(m_ctrlH5,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset6() 
{
	Use_TK(m_ctrlH6,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset7() 
{
	Use_TK(m_ctrlH7,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset8() 
{
	Use_TK(m_ctrlH8,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset9() 
{
	Use_TK(m_ctrlH9,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset10() 
{
	Use_TK(m_ctrlH10,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset11() 
{
	Use_TK(m_ctrlH11,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffset12() 
{
	Use_TK(m_ctrlH12,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickSaveOffset() 
{
	CMainFrame *pFrame = (CMainFrame*)AfxGetMainWnd();
	CP8CA_LcDispDoc *pDoc = (CP8CA_LcDispDoc*)pFrame->GetActiveDocument();
	CString str;
	...
	pDoc->Save_Vision_X_Offset(); 
	pDoc->Save_Vision_Y_Offset();
	
	OnBtn_Ctr(TRUE);
}

void CManuVisionWings::OnDblClickTitle(LPDISPATCH Cancel) 
{
	CVision_Result dlg;
	dlg.DoModal();
}

void CManuVisionWings::OnClickCalStart() 
{
	CNormalMsg dlg;
	dlg.m_strTitle = "be careful..";
	dlg.m_strMsg1 = "실행하겠습니까?";
...
void CManuVisionWings::OnClickHeadNo() 
{
	Use_TK(m_ctrlHead,MAX_NOZZLE,1,0,0);
}

void CManuVisionWings::OnClickSStart() 
{
	Use_TK(m_ctrlS_Start,1250.0,-1250,0,0);
}

void CManuVisionWings::OnClickKStartPos() 
{
	Use_TK(m_ctrlK_Start,1100.0, -1100.0, 0,0);
}

void CManuVisionWings::OnClickKEndPos() 
{
	Use_TK(m_ctrlK_End,1110.0, -1110.0,0,0);
}

void CManuVisionWings::OnClickSMoveCount() 
{
	Use_TK(m_ctrlS_Count,50,10,0,0);
}

void CManuVisionWings::OnClickSMoveDist() 
{
	Use_TK(m_ctrlS_Dist,1000.0,0.0,0,0);
}

void CManuVisionWings::OnClickDropAmount() 
{
	Use_TK(m_ctrlAmount,5.0,0.5,0,0);
}

void CManuVisionWings::Save_Cal()
{
	CMainFrame *pFrame = (CMainFrame *)AfxGetMainWnd();
	CP8CA_LcDispDoc *pDoc = (CP8CA_LcDispDoc *)pFrame->GetActiveDocument();
	FILE *fp;
...
void CManuVisionWings::Read_Cal()
{
	CMainFrame *pFrame = (CMainFrame *)AfxGetMainWnd();
	CP8CA_LcDispDoc *pDoc = (CP8CA_LcDispDoc *)pFrame->GetActiveDocument();
	ifstream fi;
...
void CManuVisionWings::OnClickOffset13() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlH13,20.0,-20.0,0,0);	
}

void CManuVisionWings::OnClickOffset14() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlH14,20.0,-20.0,0,0);	
}

void CManuVisionWings::OnClickOffset15() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlH15,20.0,-20.0,0,0);	
}

void CManuVisionWings::OnClickOffset16() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlH16,20.0,-20.0,0,0);	
}

void CManuVisionWings::SelectLanguage()
{
	CMainFrame *pFrame = (CMainFrame*)AfxGetMainWnd();
	CP8CA_LcDispView* pView = (CP8CA_LcDispView*)pFrame->GetActiveView();
...
void CManuVisionWings::OnClickOffsetX1() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX1,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX2() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX2,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX3() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX3,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX4() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX4,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX5() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX5,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX6() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX6,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX7() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX7,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX8() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX8,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX9() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX9,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX10() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX10,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX11() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX11,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX12() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX12,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX13() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX13,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX14() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX14,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX15() 
{
	// TODO: Add your control notification handler code here
	Use_TK(m_ctrlX15,20.0,-20.0,0,0);
}

void CManuVisionWings::OnClickOffsetX16() 
{
	// TODO: Add your control notification handler code here
